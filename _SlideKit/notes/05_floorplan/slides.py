...
SPECS = [
    ...
    split("1.3 Floorplan 的目标", "本质是逻辑→物理的映射", "f01_position.png", [
        ...
        "因此 Floorplan 是在面积、时序、拥塞与供电可靠性之间做的**第一轮工程取舍**。",
    ...
    ], note="这些对象会**互相抢空间**：IO 区在外圈、核心区在内部、宏单元会切割标准单元区域，电源网格又要从焊盘把电送到每个单元；一个好的 floorplan，要让这些对象**抢得有秩序**。"),
    ...
    ], style="prose", caption="真实芯片顶层金属：几乎整层用于供电网", credit="Bitfury 顶层金属供电网 · ZeptoBars · CC BY 3.0 · Wikimedia"),
    ...
    ], style="prose", caption="静态 IR 压降颜色图 + 热点掩码", credit="WACA-UNet, Seo et al. · arXiv:2507.19197 · CC BY 4.0"),
