...
### 6.2 core limited vs pad limited（核心受限 vs 焊盘受限）
...
### 6.3 total vs effective utilization；为什么不能只看利用率
...
### 6.4 placement region / placement blockage / routing blockage：各限制什么
...
### 6.5 halo vs placement blockage（留边 vs 布局阻挡）
...
### 6.6 IR drop vs EM（短期电压 vs 长期可靠性）
...
### 6.7 flat vs hierarchical：为什么牵出 timing budget、feedthrough、ILM/ETM
