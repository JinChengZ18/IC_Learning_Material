...
六篇独立、自洽的 Markdown 笔记，**已按逻辑（学习/流程）顺序编号**：全流程总览 → RTL → 输入文件 → SDC → Floorplan → Placement。每篇按 **「是什么 / 为什么 / 怎么做 / 常见坑」** 组织，文末附 **本章小结** 与 **面试高频考点**，并配 Mermaid 图与代码示例。
...
以**面试/复习**为目标，可直接跳每篇末尾的「面试高频考点」集中突破。
